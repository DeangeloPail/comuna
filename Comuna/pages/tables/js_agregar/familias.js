...
//inserto datos con llamando a la funcion php
    ...
    fetch('./sql_agregar/sen_familia.php', {
        method: 'POST',
        body: formulario
    })
    .then(res => res.json())
    .then(data => {
      ...
      Swal.fire({
        icon: 'success',
        title: '¡Se guardaron los datos! ¿Deseas Agregar Otra Familia?',
        showConfirmButton: false,
        html:'<a class="btn btn-primary mx-1 py-2 px-3" href="./agre_familias.php">Si</a>'+
             '<a class="btn btn-danger mx-1 py-2 px-3" href="./familias.php" role="button">No</a>'
      })
