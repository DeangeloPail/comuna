...
//inserto datos con llamando a la funcion php
    ...
    fetch('./sql_agregar/sen_reporte.php', {
        method: 'POST',
        body: formulario
    })
    .then(res => res.json())
    .then(data => {
     ...
     Swal.fire({
        icon: 'success',
        title: '¡Se guardaron los datos! ¿Deseas Agregar Otro Reporte?',
        showConfirmButton: false,
        html:'<a class="btn btn-primary mx-1 py-2 px-3" href="./reporte_servicios.php">Si</a>'+
             '<a class="btn btn-danger mx-1 py-2 px-3" href="../reporte_servicios.php" role="button">No</a>'
      })
