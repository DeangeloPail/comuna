...
//inserto datos con llamando a la funcion php
    ...
    fetch('./sql_agregar/sen_usuario.php', {
        method: 'POST',
        body: formulario
    })
    .then(res => res.json())
    .then(data => {
      ...
      Swal.fire({
        icon: 'success',
        title: '¡Se guardaron los datos! ¿Deseas Agregar Otro Usuario?',
        showConfirmButton: false,
        html:'<a class="btn btn-primary mx-1 py-2 px-3" href="./agre_usuario.php">Si</a>'+
             '<a class="btn btn-danger mx-1 py-2 px-3" href="./usuario.php" role="button">No</a>'
      })
