...
<head>
  ...
  <title>C.C Las Margaritas|Editar Habitante</title>
...
ob_start();
  ...
  $id=$_GET['id'];
  $sql="SELECT * FROM `int_familia`WHERE `id_int_fam`='".$id."'";
  $resultadoIntegranteFamilia=mysqli_query($conexion,$sql);

  $filaIntegrante=mysqli_fetch_assoc($resultadoIntegranteFamilia);
  $IdIntegrante=$filaIntegrante["id_int_fam"];
  $NombreIntFam=$filaIntegrante["nombre_inf"];
  $ApellidoIntegrante=$filaIntegrante["apelli_inf"];
  $DocumentoInt=$filaIntegrante["cedula_inf"];
  $FechaDeNacimiento=$filaIntegrante["fecha_naci"];
  $Telefono=$filaIntegrante["telef_intef"];
  $Profecion=$filaIntegrante["profecion_"];
  $Enfermedad=$filaIntegrante["enfermedad"];
  $Ayuda=$filaIntegrante["ayuda_reci"];
  $Dosis=$filaIntegrante["nume_dosis"];
  $Otros=$filaIntegrante["otras_vacu"];
  ...
  <div class="row mt-5">
    ...
    <form class="row g-3 needs-validation " method="POST" enctype="multipart/form-data" id="formulario" novalidate >
        <div class = "form-group">
            <input type="hidden"  required readonly class="form-control mt-3" value="<?php echo $IdIntegrante; ?>" name="IdIntegrante" id="IdIntegrante">
        </div>

        <div class=" position-relative">
            <label for="NombreIntFam" class="form-label">Nombre de integrante de familia</label>
            <input type="text" autocomplete="off" class="form-control" id="NombreIntFam" name="NombreIntFam" value="<?php echo $NombreIntFam; ?>" required>
        ...
        <div class=" position-relative">
            ...
            <input type="text" autocomplete="off" class="form-control" id="ApellidoIntegrante" name="ApellidoIntegrante" value="<?php echo $ApellidoIntegrante; ?>" required>
        ...
        <div class=" position-relative">
            ...
            <input type="text" autocomplete="off" class="form-control" id="DocumentoInt" name="DocumentoInt" value="<?php echo $DocumentoInt; ?>" required>
        ...
        <div class=" position-relative">
            ...
            <input type="date" autocomplete="off" class="form-control" id="FechaDeNacimiento" name="FechaDeNacimiento"value="<?php echo $FechaDeNacimiento; ?>"  required>
        ...
        <div class=" position-relative">
            ...
            <input type="tel" autocomplete="off" class="form-control" id="Telefono" name="Telefono" value="<?php echo $Telefono; ?>"required>
        ...
        <div class=" position-relative">
            ...
            <input type="text" autocomplete="off" class="form-control" id="Profecion" name="Profecion"  value="<?php echo $Profecion; ?>"required>
        ...
        <div class=" position-relative">
            ...
            <input type="text" autocomplete="off" class="form-control" id="Enfermedad" name="Enfermedad" value="<?php echo $Enfermedad; ?>" required>
        ...
        <div class=" position-relative">
            ...
            <input type="text" autocomplete="off" class="form-control" id="Ayuda" name="Ayuda"  value="<?php echo $Ayuda; ?>"required>
        ...
        <div class=" position-relative">
            ...
            <input type="text" autocomplete="off" class="form-control" id="CantDosis" name="CantDosis" value="<?php echo $Dosis; ?>" required>
        ...
        <div class=" position-relative">
            ...
            <input type="text" autocomplete="off" class="form-control" id="Otros" name="Otros" value="<?php echo $Otros; ?>" required>
...
<script src="./js_editar/integrante.js"></script>
